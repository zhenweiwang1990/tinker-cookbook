...
class Task23PreHook:
    ...
    def run(self, adb_client: AdbClient) -> bool:
        queries: List[str] = [
            "INSERT INTO messages (id, thread_id, listing_id, host_name, host_id, user_email, body, created_at) VALUES ('1766125874673-o1ksoty0','25936-Carl','25936','Carl','Carl','local@airbnb.com','1111',1766125874673);"
        ]
        for sql in queries:
